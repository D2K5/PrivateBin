...
?>
			...
			<footer class="container">
				<div class="row">
					<p class="col-md-5 col-xs-8"><a href="https://d2k5.com/">Return to D2K5</a></p>
					<p class="col-md-1 col-xs-4 text-center"><!--<?php echo $VERSION; ?>--></p>
					<p id="aboutbox" class="col-md-6 col-xs-12">
						This pastebin runs a custom-themed <a href="https://privatebin.info/" target="_blank">PrivateBin</a>; a minimalist, open source online pastebin where the server has zero knowledge of pasted data.<br/>
						<br/>Data is encrypted/decrypted client-side in the browser using AES-256.
					</p>
				</div>
			</footer>
		</main>
